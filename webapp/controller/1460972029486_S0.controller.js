sap.ui.define(["sap/ui/core/mvc/Controller",
	...
	return BaseController.extend("com.sap.build.standard.approveTravelRequests.controller.1460972029486_S0", {
		...
		_onSearchFieldLiveChange: function (oEvent) {
			var sControlId = "sap_List_Page_0-content-sap_m_ObjectList-1527500729638";
			...
			return new Promise(function (fnResolve) {
				...
				if (sQuery && sQuery.length > 0) {
					...
					if (!isNaN(iQuery)) {
						aFilters.push(new sap.ui.model.Filter("Amount", sap.ui.model.FilterOperator.EQ, sQuery));
					}

					aFilters.push(new sap.ui.model.Filter("Currency", sap.ui.model.FilterOperator.Contains, sQuery));

					aFilters.push(new sap.ui.model.Filter("Destination", sap.ui.model.FilterOperator.Contains, sQuery));

					aFilters.push(new sap.ui.model.Filter("Dates", sap.ui.model.FilterOperator.Contains, sQuery));

					aFilters.push(new sap.ui.model.Filter("ActivityType", sap.ui.model.FilterOperator.Contains, sQuery));

					aFilters.push(new sap.ui.model.Filter("CommentText", sap.ui.model.FilterOperator.Contains, sQuery));

					aFilters.push(new sap.ui.model.Filter("CommentDate", sap.ui.model.FilterOperator.Contains, sQuery));

					aFilters.push(new sap.ui.model.Filter("FullAmount", sap.ui.model.FilterOperator.Contains, sQuery));

					aFilters.push(new sap.ui.model.Filter("NbCostAssignments", sap.ui.model.FilterOperator.Contains, sQuery));
		...
		onInit: function () {
			...
			this.oRouter.getTarget("1460972029486_S0").attachDisplay(jQuery.proxy(this.handleRouteMatched, this));
		...
		onExit: function () {
			...
			var aControls = [{
				"controlId": "sap_List_Page_0-content-sap_m_ObjectList-1527500729638",
				"groups": ["items"]
			}];
